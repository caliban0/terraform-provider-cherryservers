...
- `ip` resource and data source attribute `ddos_scrubbing` is now deprecated and will be removed in a future release.
...
[1.1.0]: https://github.com/cherryservers/terraform-provider-cherryservers/compare/v1.0.0...1.1.0
